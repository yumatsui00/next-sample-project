...
echo "Scaffolding files and directories..."
...
mkdir -p \
  ...
  AI/task/templates \
  assets/translations \
  "features/(sample)/components" \
  "features/(sample)/services" \
  "features/(sample)/repsitories" \
  "features/(sample)/shemas" \
  "features/(sample)/types" \
  libs \
  utils \
  types \
  constants
...
# .gitkeep files
touch \
  .github/worktree/.gitkeep \
  AI/task/ui/.gitkeep \
  "features/(sample)/components/.gitkeep" \
  "features/(sample)/services/.gitkeep" \
  "features/(sample)/repsitories/.gitkeep" \
  "features/(sample)/shemas/.gitkeep" \
  "features/(sample)/types/.gitkeep" \
  libs/.gitkeep \
  utils/.gitkeep \
  types/.gitkeep \
  constants/.gitkeep
...
cat <<'EOF' > AI/task/templates/instruction_template.md
...
# seed_empty.md
cat <<'EOF' > AI/task/templates/seed_empty.md
# Feature Seed
...
# seed_template.md
cat <<'EOF' > AI/task/templates/seed_template.md
# Feature Seed
...
# seed.md same as empty
cp AI/task/templates/seed_empty.md AI/task/seed.md

# jp.ts
cat <<'EOF' > assets/translations/jp.ts
export const jp = {}
EOF
